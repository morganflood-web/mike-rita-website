...
export default function ContactPage() {
  return (
    <>
      <SiteHeader />
      <main style={{ backgroundColor: "#1a0f0a", minHeight: "60vh" }}>
        <section style={{ padding: "80px 32px 100px" }}>
          <div style={{ maxWidth: "700px", margin: "0 auto", textAlign: "center" }}>
            ...
            <p style={{ color: "#B8A898", fontSize: "0.95rem", lineHeight: 1.7, marginBottom: "32px" }}>
              For all booking inquiries, reach out to Grand Wave Entertainment.
            </p>
            <p
              style={{
                fontSize: "0.7rem",
            ...
            <div style={{ display: "flex", gap: "48px", justifyContent: "center", flexWrap: "wrap" }}>
              <div style={{ textAlign: "center" }}>
                <p style={{ color: "#F5F0E8", fontSize: "1rem", marginBottom: "8px", fontWeight: 600 }}>Morgan Flood</p>
                <a
                  href="mailto:morgan@grandwaveentertainment.com"
                  style={{ color: "#E8651A", fontSize: "0.9rem", textDecoration: "none", wordBreak: "break-all" }}
                >
                  morgan@grandwaveentertainment.com
                </a>
              </div>
              <div style={{ textAlign: "center" }}>
                <p style={{ color: "#F5F0E8", fontSize: "1rem", marginBottom: "8px", fontWeight: 600 }}>Carolyn Sterling</p>
                <a
